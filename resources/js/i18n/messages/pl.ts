...
const messages = {
  ...
  routes: {
    ...
    profile: 'Profil',
    login: 'Logowanie',
    passwordForgot: 'Reset hasła',
    passwordReset: 'Ustaw nowe hasło',
  ...
  auth: {
    ...
    forgotPassword: {
      ...
      email: 'E-mail',
      submit: 'Wyślij link',
      success: 'Jeżeli konto istnieje, wysłaliśmy instrukcję resetu na {email}.',
      error: 'Nie udało się wysłać wiadomości resetującej hasło.',
      backToLoginPrefix: 'Pamiętasz hasło?',
    ...
    resetPassword: {
      ...
      success: 'Hasło zostało zmienione. Za chwilę przeniesiemy Cię do logowania.',
      error: 'Nie udało się ustawić nowego hasła.',
      invalidLink: 'Ten link resetu jest nieprawidłowy albo niekompletny.',
      backToLoginPrefix: 'Chcesz wrócić?',
      backToLoginLink: 'Przejdź do logowania',
    },
    social: {
      divider: 'lub',
